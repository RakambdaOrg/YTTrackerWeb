...
<!--        <li class="nav-item"><a class="nav-link" href="?all=0">See current month data</a></li>-->
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item extensionsAd"><a class="nav-link" target="_blank" href="https://addons.mozilla.org/en-US/firefox/addon/youtube-tracker/">Get the firefox addon</a></li>
    </ul>
</nav>